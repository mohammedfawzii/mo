        ...
        <div class="col-lg-12">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ route('projects.create') }}" type="button" class="btn btn-success mb-3">Add Project</a>
                            ...
                            <tbody>
                                @foreach ($project as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td>{{ $item->link }}</td>
                                        <td><img style="width: 100px" src="{{ $item->img}}" alt="null"></td>
                                        <td>{{ $item->section }}</td>
                                        <td>
                                            <div style="display: flex">
                                                <div class="fa-hover ml-3"><a
                                                        href="{{ route('projects.edit', $item->id) }}"><button
                                                            class="editBtn">
